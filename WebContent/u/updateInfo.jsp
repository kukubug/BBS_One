...
<script type="text/javascript">
	...
	return true;
 	...
 	var usex = '${session.tu.sex}';
 	$(document).ready(function(){
 		if("男" == usex){
 	 		$("#man-radio").attr('checked',"checked");
 	 	}else{
 	 		$("#woman-radio").attr('checked',"checked");
 	 	}
 	});
</script>
...
<div id="home">
				...
				<table>
					...
					<tr>
						...
						<td><input name="userSex" type="radio" 
							value="男" id="man-radio"> 男<input name="userSex" type="radio"
							value="女" id="woman-radio"> 女</td>
					</tr>
					<tr>
						<td>邮&nbsp;&nbsp;&nbsp;箱</td>
	...
	<div align="center"
		...
		<p>
			<img alt="我的头像" style="width: 160px;height: 220px;"  onerror="this.src='./image/chen-Java.png'" 
